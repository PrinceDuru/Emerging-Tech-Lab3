...
//
import VitalsignsHome from './VitalsignsHome'
//
// mutation for patient login
...
function Login() {
    ...
    // loginPatient is a function that can be called to execute
    ...
    //
    //state variable for the screen, admin or patient
    const [screen, setScreen] = useState(false);
    //store input field data, patient name and password
    ...
    const handleLogin = async (event) => {
        ...
        try {
          ...
          console.log('Logged in as:', data.loginPatient);
          setScreen(data.loginPatient);
          setEmail('');
          setPassword('');
        ...
        const checkLoginStatus = async () => {
            try {
                ...
                if (isLoggedInVar !== undefined && isLoggedInVar !== screen) {
                    console.log('Patient is logged in');
                    console.log('screen: ', screen);
  ...
  if (isLoggedInData?.isLoggedIn === true) {
    ...
    return (
        <div className="entryform">
            { screen !==false ? (
                <VitalsignsHome screen={screen} setScreen={setScreen} /> ) : (
